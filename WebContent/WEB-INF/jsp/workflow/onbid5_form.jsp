...
function forSubmit() {
	...
	if(window.confirm("确实要提交?")){
	frm.action="${root}/workflow/onbid5!submit.do";  
 	frm.submit();
	}
}
...
<body>
<html:pagetitle title="项目招标->提交招标部门上传开标会记录"/>
...
<table width="99%" class="table" cellpadding="0" cellspacing="0" align="center">
    ...
    <tr>
        <td height="24" align="right" class="td_lable">标管理部门负责人</td>
        <td class="td_edit" colspan="3">		
    ...
    <tr>
     ...
     <tr>
        <td height="24" align="right" class="td_lable">招标部门人员(上传开标会记录)</td>
        <td class="td_edit" colspan="3">		
	...
	<tr>
      ...
      <td class="td_edit" colspan="3">	
      <input type="button" onclick="forSubmit()"  value="提交招标部门">
