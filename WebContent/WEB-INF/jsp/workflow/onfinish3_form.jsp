...
function forsubmit() {
	...
	if(window.confirm("确定要提交?")){
		frm.action="${root}/workflow/onfinish3!submit.do";  
 		frm.submit();
	}
}
</script>
...
<s:actionerror />
<s:actionmessage />
<s:form id="itemForm" action="onfinish3!submit.do" method="post"  enctype="multipart/form-data">
...
<table width="100%" class="table" cellpadding="0" cellspacing="0" align="center">
   ...
   <tr>
        <td height="24" align="right" class="td_lable">纪检委</td>
        <td class="td_edit" colspan="3">		
	...
	<tr>
      ...
      <td class="td_edit" colspan="3">	
      <input type="button" onclick="forsubmit()"  value="提报纪检委审核">
