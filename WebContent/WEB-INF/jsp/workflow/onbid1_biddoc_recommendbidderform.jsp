...
<s:actionerror />
<s:actionmessage />
<s:form id="bidForm" action="onbid1_biddoc!recommendBidderSave.do" method="post"  enctype="multipart/form-data">
...
<table width="99%" class="table" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
      ...
      <input type="submit"  value="保存">
       <input type="button" onclick="location.href='${root}/workflow/onbid1_biddoc!input.do?item.id=<s:property value="item.id"/>'" value="返回">
      </td>
      <td>&nbsp;</td>
    </tr>	
</table>
