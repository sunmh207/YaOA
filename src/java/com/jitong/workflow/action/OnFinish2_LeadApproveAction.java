...
public class OnFinish2_LeadApproveAction extends JITActionBase implements Preparable {
	...
	public String approve() {
		try {
			...
			String hql="select count(*) as cnt from ItemApprove approve where approve.type='"+ItemApprove.TYPE_ONFINISH_LEAD_APPROVE+"' and approve.itemId='" + itemFinish.getId() + "' and approve.status='"+ItemApprove.STATUS_PENDING+"'";
